...
public class CartController {
    ...
    public ResponseEntity<Object> addProductToCart(@PathVariable Integer idCart, @RequestBody Product product) {
        ResponseBuilder response = this.cartService.addProduct(idCart, product);
